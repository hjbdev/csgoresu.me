...
class UserController extends Controller
{
    public function index(Request $request)
    {
        ...
        ])->whereNotNull('roles')->whereNotIn('steam_id', ['76561198080330700', '76561198079662029', '76561198158594990', '76561198090815918'])->where('show', true)->orderByDesc('faceit_rank')->where('updated_at', '>', now()->subMonth())->paginate(20);
